                ...
                <Card key={car?._id} style={{ width: '18rem', height: "24rem", position: "relative" }} className="carsdiv1">
                    ...
                    <div className='gray-bg'>
                        <div >
                                ...
                                {car?.nextAvailibility!==null && <p style={{position:"absolute",top:"30%",color:"black",fontWeight:"bolder",marginLeft:"0.5rem",fontSize:"1.1rem"}}>Next Availibility {new Date(car?.nextAvailibility).toDateString()}</p>}
                            </div>
                        {user.role === "owner" &&
                            <div>
